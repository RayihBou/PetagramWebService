package comrayihbou.github.pentagramunam.restApi.deserializador;
...
import comrayihbou.github.pentagramunam.restApi.JsonKeys;
...
public class MascotaDeserializador implements JsonDeserializer<MascotaResponse> {
    ...
    public MascotaResponse deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        //Importamos las llaves de la clase JsonKeys
        //Utilizamos un JsonArray cuando queremos accesar a un arreglo {}
    ...
    private ArrayList<Mascotas> deserializarMascotaDeJson(JsonArray mascotaResponseData){
        ...
        for (int i = 0; i < mascotaResponseData.size(); i++) {
            //Utilizamos un JsonObject cuando queremos accesar a un objeto [
            ...
            JsonObject stdResolutionJson            = imageJson.getAsJsonObject(JsonKeys.MEDIA_STANDARD_RES);
